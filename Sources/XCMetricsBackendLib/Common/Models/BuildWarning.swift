...
extension BuildWarning {
    ...
    func withNotice(_ notice: Notice) -> BuildWarning {
        self.title = notice.title
        self.type = notice.type.rawValue
        self.documentURL = notice.documentURL
        self.clangFlag = notice.clangFlag ?? ""
    ...
    func withBuildIdentifier(_ buildIdentifier: String) -> BuildWarning {
        self.buildIdentifier = buildIdentifier
        return self
    }

    func withParentIdentifier(_ parentIdentifier: String) -> BuildWarning {
        self.parentIdentifier = parentIdentifier
        return self
    }

    func withParentType(_ parentType: String) -> BuildWarning {
