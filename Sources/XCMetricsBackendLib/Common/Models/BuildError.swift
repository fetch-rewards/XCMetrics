...
extension BuildError {
    ...
    func withNotice(_ notice: Notice) -> BuildError {
    ...
    func withBuildIdentifier(_ buildIdentifier: String) -> BuildError {
        self.buildIdentifier = buildIdentifier
        return self
    }

    func withParentIdentifier(_ parentIdentifier: String) -> BuildError {
        self.parentIdentifier = parentIdentifier
        return self
    }

    func withParentType(_ parentType: String) -> BuildError {
